...
require("../models/with-mongoose/PopupNEW");
        ...
        body("category", "Pop-up category can't be blank.")
          ...
          .isString(),
				body("popupTitle", "Pop-up title can't be blank.")
					...
					.exists()
					.isString(),
					body("slots.date.from", "Slots from date is required and must be a date.")
					.exists()
					.isISO8601(),
					body("slots.date.to", "Slots to date is required and must be a date.")
					.exists()
					.isISO8601(),
				body("popupOrganizer.name", "Pop-up organizer is required and must be a String")
					.exists()
					.isString(),
        body("popupOrganizer.websiteUrl", "Must be a valid URL.")
          .isURL({
            ...
            require_protocol: true,
					...
					body("popupOrganizer.email", "Email can't be blank and must be a valid email address.")
					.exists()
					.isEmail(),
				body("joinedOrganizers", "Joined organizers must be an array of strings.")
          .isArray()
					.optional({nullable: true }),
    ...
    case "updatePopup": {
      return [
        ...
        body("popupTitle", "Popup title must be a string.")
					.isString()
					.optional(),
				body("description", "Pop-up description is required and can't be blank.")
					.isString()
					.optional(),
